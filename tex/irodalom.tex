...
\label{eq:field}
\end{equation}
Ahol $\nabla \Phi$ az elektromos mező gradiense. A Nabla egy matematikában használt vektor differenciál operátor. Alkalmazhatjuk egy dimenzióban, mely esetben egy adott függvény standard deriváltjára utal. Több dimenzióban, vagyis egy mezőre alkalmazva, jelölheti bármely három operátort (grádiense, divergenciája vagy rotációja egy vektor mezőnek). Ez utóbbira a következőképp írható fel:
